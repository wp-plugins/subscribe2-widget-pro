...
<div class="submission-options toggle-item">
	...
	<p>
		...
		<span class="s2w-field-detail"><?php _e( '<strong>Important:</strong> Post form page must contain <code>[subscribe2]</code> shortcode to properly send emails', 's2w' ); ?></span>
