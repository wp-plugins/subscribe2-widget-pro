...
<div id="s2w-widget-pro-premium" class="postbox">
	...
	<h3 class="hndle"><span><?php _e( 'Subscribe2 Widget Pro Premium', 's2w' ); ?></span></h3>
	...
	<div class="inside">
		...
		<div class="control-group">
			...
			<div class="control-label">
				<label for="s2w_widget_premium_email"><?php _e( 'License Email', 's2w' ); ?>
					<img src="<?php echo S2W_WIDGET_PRO_URL . '/includes/images/help.png' ?>" title="<?php _e( 'This is the address you purchased the license key with and received email confirmation.', 's2w' ); ?>" class="tooltip-info" width="16" height="16" /></label>
			</div>
			...
			<div class="controls">
				...
				<input type="<?php if ( S2W_DEBUG == true ) {
					echo "text";
				} else {
					echo "hidden";
				} ?>" id="s2w_widget_premium_license_status" name="s2w_widget_settings[s2w_widget_premium_license_status]" value="<?php echo s2w_widget_option( 's2w_widget_premium_license_status', $options ); ?>" />
			</div>
		</div>
		<!--/.control-group -->
		<div class="control-group">
			<div class="control-label">
				<label for="s2w_widget_premium_license"><?php _e( 'License Key', 's2w' ); ?>
					<img src="<?php echo S2W_WIDGET_PRO_URL . '/includes/images/help.png' ?>" title="<?php _e( 'The license key can be found in your confirmation email. If you lost your license you can <a href=\'http://wordimpress.com/lost-licence/\' target=\'_blank\' class=\'new-window\'>request it sent by email</a>.', 's2w' ); ?>" class="tooltip-info" width="16" height="16" /></label>
			</div>
